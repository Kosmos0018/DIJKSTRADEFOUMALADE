...
/**
 * contient_arrete_liste : test si l'arête donnée appartient à la liste donnée.
 * L'arête (source, destination) appartient à la liste ssi source et destination appartiennent 
 ...
 * @param destination noeud destination de l'arête
 * @return vrai ssi l'arête (source,destination) est dans liste
 */
